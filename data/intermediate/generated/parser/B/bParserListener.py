...
# This class defines a complete listener for a parse tree produced by bParser.
class bParserListener(ParseTreeListener):

    # Enter a parse tree produced by bParser#program.
    def enterProgram(self, ctx:bParser.ProgramContext):
        pass

    # Exit a parse tree produced by bParser#program.
    def exitProgram(self, ctx:bParser.ProgramContext):
        pass
    ...
    def exitDefinition(self, ctx:bParser.DefinitionContext):
        pass
    ...
    def enterStatement(self, ctx:bParser.StatementContext):
        pass

    # Exit a parse tree produced by bParser#statement.
    def exitStatement(self, ctx:bParser.StatementContext):
        pass


    # Enter a parse tree produced by bParser#nullstmt.
    def enterNullstmt(self, ctx:bParser.NullstmtContext):
        pass

    # Exit a parse tree produced by bParser#nullstmt.
    def exitNullstmt(self, ctx:bParser.NullstmtContext):
        pass


    # Enter a parse tree produced by bParser#expressionstmt.
    def enterExpressionstmt(self, ctx:bParser.ExpressionstmtContext):
        pass

    # Exit a parse tree produced by bParser#expressionstmt.
    def exitExpressionstmt(self, ctx:bParser.ExpressionstmtContext):
        pass


    # Enter a parse tree produced by bParser#blockstmt.
    def enterBlockstmt(self, ctx:bParser.BlockstmtContext):
        pass

    # Exit a parse tree produced by bParser#blockstmt.
    def exitBlockstmt(self, ctx:bParser.BlockstmtContext):
        pass
    ...
    def enterGotostmt(self, ctx:bParser.GotostmtContext):
        pass

    # Exit a parse tree produced by bParser#gotostmt.
    def exitGotostmt(self, ctx:bParser.GotostmtContext):
        pass


    # Enter a parse tree produced by bParser#switchstmt.
    def enterSwitchstmt(self, ctx:bParser.SwitchstmtContext):
        pass

    # Exit a parse tree produced by bParser#switchstmt.
    def exitSwitchstmt(self, ctx:bParser.SwitchstmtContext):
        pass


    # Enter a parse tree produced by bParser#whilestmt.
    def enterWhilestmt(self, ctx:bParser.WhilestmtContext):
        pass

    # Exit a parse tree produced by bParser#whilestmt.
    def exitWhilestmt(self, ctx:bParser.WhilestmtContext):
        pass
    ...
    def enterCasestmt(self, ctx:bParser.CasestmtContext):
        pass

    # Exit a parse tree produced by bParser#casestmt.
    def exitCasestmt(self, ctx:bParser.CasestmtContext):
        pass
    ...
    def enterAutosmt(self, ctx:bParser.AutosmtContext):
        pass

    # Exit a parse tree produced by bParser#autosmt.
    def exitAutosmt(self, ctx:bParser.AutosmtContext):
        pass
    ...
    def enterTernary(self, ctx:bParser.TernaryContext):
        pass

    # Exit a parse tree produced by bParser#ternary.
    def exitTernary(self, ctx:bParser.TernaryContext):
        pass


    # Enter a parse tree produced by bParser#comparison.
    def enterComparison(self, ctx:bParser.ComparisonContext):
        pass

    # Exit a parse tree produced by bParser#comparison.
    def exitComparison(self, ctx:bParser.ComparisonContext):
        pass


    # Enter a parse tree produced by bParser#assignment.
    def enterAssignment(self, ctx:bParser.AssignmentContext):
        pass

    # Exit a parse tree produced by bParser#assignment.
    def exitAssignment(self, ctx:bParser.AssignmentContext):
        pass


    # Enter a parse tree produced by bParser#expression.
    def enterExpression(self, ctx:bParser.ExpressionContext):
        pass

    # Exit a parse tree produced by bParser#expression.
    def exitExpression(self, ctx:bParser.ExpressionContext):
        pass


    # Enter a parse tree produced by bParser#functioninvocation.
    def enterFunctioninvocation(self, ctx:bParser.FunctioninvocationContext):
        pass

    # Exit a parse tree produced by bParser#functioninvocation.
    def exitFunctioninvocation(self, ctx:bParser.FunctioninvocationContext):
        pass
    ...
    def exitFunctionparameters(self, ctx:bParser.FunctionparametersContext):
        pass
    ...
    def enterIncdec(self, ctx:bParser.IncdecContext):
        pass

    # Exit a parse tree produced by bParser#incdec.
    def exitIncdec(self, ctx:bParser.IncdecContext):
        pass


    # Enter a parse tree produced by bParser#unary.
    def enterUnary(self, ctx:bParser.UnaryContext):
        pass

    # Exit a parse tree produced by bParser#unary.
    def exitUnary(self, ctx:bParser.UnaryContext):
        pass


    # Enter a parse tree produced by bParser#binary.
    def enterBinary(self, ctx:bParser.BinaryContext):
        pass

    # Exit a parse tree produced by bParser#binary.
    def exitBinary(self, ctx:bParser.BinaryContext):
        pass


    # Enter a parse tree produced by bParser#lvalue.
    def enterLvalue(self, ctx:bParser.LvalueContext):
        pass

    # Exit a parse tree produced by bParser#lvalue.
    def exitLvalue(self, ctx:bParser.LvalueContext):
        pass


    # Enter a parse tree produced by bParser#constant.
    def enterConstant(self, ctx:bParser.ConstantContext):
        pass

    # Exit a parse tree produced by bParser#constant.
    def exitConstant(self, ctx:bParser.ConstantContext):
        pass


    # Enter a parse tree produced by bParser#name.
    def enterName(self, ctx:bParser.NameContext):
        pass
